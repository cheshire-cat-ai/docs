      ...
      sidebar: [
        {
          label: 'Quickstart',
          items: [
            { label: 'Introduction', slug: 'quickstart/introduction' },
            { label: 'Installation and First Configuration', slug: 'quickstart/installation-configuration' },
            { label: 'Playing with the Cat', slug: 'quickstart/play-with-the-cat' },
            { label: 'Uploading a Document', slug: 'quickstart/upload-document' },
            { label: 'Installing a Plugin', slug: 'quickstart/installing-plugin' },
            { label: 'Creating a Plugin', slug: 'quickstart/prepare-plugin' },
            { label: 'Writing the first Tool', slug: 'quickstart/writing-tool' },
            { label: 'Writing the first Hook', slug: 'quickstart/writing-hook' },
