...
To set environment variables:
 ...
 - [Here](https://github.com/cheshire-cat-ai/core/blob/main/.env.example) there is a example you can use as a reference.
...
This option is mapped to the `--proxy_headers` Uvicorn option, you can reference the [Uvicorn HTTP setting](https://www.uvicorn.org/settings/#http) page for more info.

### CCAT_CORS_FORWARDED_ALLOW_IPS
Default value: `*`

When the `CCAT_HTTPS_PROXY_MODE` option is enabled, this option is mapped to the `--forwarded-allow-ips` Uvicorn option, you can reference the [Uvicorn HTTP setting](https://www.uvicorn.org/settings/#http) page for more info.
