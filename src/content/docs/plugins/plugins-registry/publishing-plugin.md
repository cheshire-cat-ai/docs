---
title: "Publishing a Plugin in the Registry"
---
...
To learn more about how to work with the plugin template, read [this dedicated page](/docs/plugins/plugins-registry/plugin-from-template/).
