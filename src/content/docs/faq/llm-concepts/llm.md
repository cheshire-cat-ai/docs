...
This type of model takes a string as input and returns a vector as output. The model is known as an *embedder*, while the vector in output is called *embedding*.
...
[Language Models hooks](/docs/plugins/hooks/)
:::

Nodes with the &#129693; point the execution places where there is an available [hook](/docs/plugins/plugins/) to customize the execution pipeline.
