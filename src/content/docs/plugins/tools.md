...
Let's say in your plugin you declare this tool, as we saw in the [quickstart](/docs/quickstart/writing-tool/):
...
To deal with [dependencies](/docs/plugins/dependencies/), you need write the 'currencyconverter' library in a `requirements.txt` inside the `myplugin` folder.  
