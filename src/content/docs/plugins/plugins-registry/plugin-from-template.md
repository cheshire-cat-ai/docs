---
title: "Using the Plugin Template"
---
...
Navigate to the [plugin_template](https://github.com/cheshire-cat-ai/plugin_template) GitHub repository, click on `Use this template` and, then, `Create a new repository`:
